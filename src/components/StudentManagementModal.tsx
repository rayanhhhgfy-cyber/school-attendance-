...
export const StudentManagementModal: React.FC<StudentManagementModalProps> = ({
  ...
  const [selectedClass, setSelectedClass] = useState<string>(
    studentToEdit?.classId || initialClassId || selectedClassId || classes[0]?.id || 'class-1a'
  );
  ...
  useEffect(() => {
    ...
    const targetClassId = studentToEdit?.classId || initialClassId || selectedClassId || classes[0]?.id || 'class-1a';
  ...
  return (
    ...
    >
      <motion.div
        ...
        className="bg-white text-slate-900 rounded-3xl shadow-2xl border border-slate-200 max-w-2xl w-full overflow-hidden flex flex-col my-auto max-h-[92vh]"
      >
        {/* Modal Top Header */}
        ...
        {(activeMode === 'add' || activeMode === 'bulk_add') && (
          <div className="px-5 pt-3 pb-1 border-b border-slate-100 bg-slate-50 flex items-center gap-2">
            <button
              type="button"
              id="tab-single-add"
        ...
        {/* Feedback Messages */}
        {errorMsg && (
          <div className="mx-5 mt-4 p-3 bg-red-50 border border-red-200 rounded-xl text-red-900 text-xs flex items-center gap-2">
        ...
        {successMsg && (
          <div className="mx-5 mt-4 p-3 bg-emerald-50 border border-emerald-200 rounded-xl text-emerald-900 text-xs flex items-center gap-2">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <div className="sm:col-span-2">
                  ...
                  <input
                    ...
                    className="w-full h-11 px-3.5 bg-slate-50 border border-slate-300 rounded-xl text-sm font-semibold text-slate-900 focus:bg-white focus:border-blue-600 focus:outline-hidden"
                  />
                </div>
                ...
                <div>
                  ...
                  <select
                    ...
                    className="w-full h-11 px-3 bg-slate-50 border border-slate-300 rounded-xl text-sm font-bold text-slate-900 focus:bg-white focus:border-blue-600 focus:outline-hidden cursor-pointer"
                  >
                    {classes.map(cls => (
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full h-11 px-3.5 bg-slate-50 border border-slate-300 rounded-xl text-sm font-bold text-slate-900 focus:bg-white focus:border-blue-600 focus:outline-hidden font-mono"
                  />
                </div>
                ...
                <div>
                  ...
                  <input
                    ...
                    dir="ltr"
                    className="w-full h-11 px-3.5 bg-slate-50 border border-slate-300 rounded-xl text-sm font-mono text-slate-900 focus:bg-white focus:border-blue-600 focus:outline-hidden text-right"
                  />
                </div>
                ...
                <div className="sm:col-span-2">
                  ...
                  <input
                    ...
                    className="w-full h-11 px-3.5 bg-slate-50 border border-slate-300 rounded-xl text-sm text-slate-900 focus:bg-white focus:border-blue-600 focus:outline-hidden"
                  />
                  {/* Quick health tags */}
                  <div className="flex flex-wrap gap-1.5 mt-2">
                    {['سليم معافى', 'حساسية طعام', 'ربو', 'سكري', 'نظارة طبية'].map(tag => (
                      <button
                        ...
                        className="px-2 py-0.5 rounded-md bg-slate-100 hover:bg-slate-200 text-slate-600 text-[11px] font-medium border border-slate-200 transition cursor-pointer"
                      >
                        {tag}
                      </button>
                    ))}
            ...
            <form onSubmit={handleBulkAdd} className="space-y-4">
              ...
              <div>
                ...
                <textarea
                  ...
                  className="w-full p-3.5 bg-slate-50 border border-slate-300 rounded-2xl text-sm font-medium text-slate-900 focus:bg-white focus:border-blue-600 focus:outline-hidden leading-relaxed font-sans"
                />
          ...
          {activeMode === 'contact' && studentToEdit && (
            <div className="space-y-4">
              ...
              <div className="bg-slate-50 border border-slate-200 rounded-2xl p-4 flex items-center justify-between">
                <div>
                  <h4 className="text-base font-extrabold text-slate-900">{studentToEdit.name}</h4>
                ...
                <div className="text-left font-mono">
                  ...
                  <span className="font-bold text-blue-900 text-sm" dir="ltr">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                <a
                  ...
                  id="btn-call-parent"
                  className="p-3 bg-blue-900 hover:bg-blue-800 text-white rounded-xl font-bold text-xs sm:text-sm flex items-center justify-center gap-2 transition shadow-xs"
                >
                ...
                <button
                  ...
                  className="p-3 bg-slate-100 hover:bg-slate-200 text-slate-800 rounded-xl font-bold text-xs sm:text-sm flex items-center justify-center gap-2 transition border border-slate-200 cursor-pointer"
                >
              ...
              <div className="space-y-2 pt-2">
                ...
                <button
                  ...
                  className="w-full p-3 rounded-xl bg-amber-50 hover:bg-amber-100 border border-amber-300 text-right transition cursor-pointer flex items-start gap-3 text-amber-950"
                >
                  <MessageCircle className="w-5 h-5 text-amber-700 flex-shrink-0 mt-0.5" />
                  <div>
                ...
                <button
                  ...
                  className="w-full p-3 rounded-xl bg-blue-50 hover:bg-blue-100 border border-blue-300 text-right transition cursor-pointer flex items-start gap-3 text-blue-950"
                >
              ...
              <div className="pt-3 border-t border-slate-100 flex items-center justify-between">
                <button
                  ...
                  className="px-3 py-2 rounded-xl bg-red-50 hover:bg-red-100 text-red-700 border border-red-200 text-xs font-bold flex items-center gap-1.5 transition cursor-pointer"
                >
